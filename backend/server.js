{
  ...
  "version": "1.0.0",
  "description": "REST API backend for Dr. Arjun Mehta's Professional Portfolio",
  "main": "server.js",
  "scripts": {
 ...
 *
 * Portfolio REST API Backend
 * Author: Dr. Arjun Mehta | Portfolio Project
 *
 * Architecture:
 *   Express → Routes → Controllers → Mongoose Models → MongoDB Atlas
 */
...
const { workshopRouter } = require('./routes/achievements'); // co-located
...
// ─── Security Middleware ─────────────────────────────────
app.use(helmet({
  crossOriginEmbedderPolicy: false, // Allow embeds for portfolio media
}));
  ...
  app.get('/api', (req, res) => {
    res.json({
      ...
      endpoints: {
        ...
        achievements: ['GET /api/achievements', 'GET /api/achievements/:id', 'POST /api/achievements*', 'PUT /api/achievements/:id*', 'DELETE /api/achievements/:id*'],
        workshops:    ['GET /api/workshops', 'GET /api/workshops/:id', 'POST /api/workshops*', 'PUT /api/workshops/:id*', 'DELETE /api/workshops/:id*'],
        contact:      ['POST /api/contact', 'GET /api/contact*', 'GET /api/contact/:id*', 'PATCH /api/contact/:id*', 'DELETE /api/contact/:id*'],
      },
      note: '* = Protected (JWT required)',
    });
  });
}
...
const server = app.listen(PORT, () => {
  ...
  console.log(`   API Ref: http://localhost:${PORT}/api`);
